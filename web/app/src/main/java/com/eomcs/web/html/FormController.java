...
public class FormController {
  ...
  public Object exam11(String name, int age, MultipartFile photo) {
    ...
    try {
      File photoFile = new File("/Users/jihyeonkim:/upload/" + photo.getOriginalFilename());
  ...
  public Object exam12(String name, int age, MultipartFile[] photo) {
    ...
    for (MultipartFile part : photo) {
      try {
        File photoFile = new File("/Users/jihyeonkim:/upload/" + part.getOriginalFilename());
    ...
    if (photo != null) {
      for (MultipartFile part : photo) {
        ...
        try {
          ...
          File photoFile = new File("/Users/jihyeonkim:/upload/" + filename);
          part.transferTo(photoFile);
        } catch (Exception e) {
          e.printStackTrace();
          return "error!";
